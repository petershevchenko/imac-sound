...
/* The Apple CS42L83 companion DAC is clocked for 44.1kHz, not 48kHz. */
const struct hda_pcm_stream cs42l83_44k1_pcm_analog_playback = {
	.rates = SNDRV_PCM_RATE_44100, /* fixed rate */
};

const struct hda_pcm_stream cs42l83_44k1_pcm_analog_capture = {
	.rates = SNDRV_PCM_RATE_44100, /* fixed rate */
};
...
struct sub_codec cs8409_cs42l42_codec = {
	...
	.suspend = cs42l42_suspend,
	.hp_pin_nid = CS8409_CS42L42_HP_PIN_NID,
	.amic_pin_nid = CS8409_CS42L42_AMIC_PIN_NID,
	.hp_jack_in = 0,
	.mic_jack_in = 0,
	.paged = 1,
	.suspended = 1,
...
struct sub_codec dolphin_cs42l42_0 = {
	...
	.suspend = cs42l42_suspend,
	.hp_pin_nid = DOLPHIN_HP_PIN_NID,
	.amic_pin_nid = DOLPHIN_AMIC_PIN_NID,
	.hp_jack_in = 0,
	.mic_jack_in = 0,
	.paged = 1,
	.suspended = 1,
...
/******************************************************************************
 *                     Apple iMac18,3 / CS42L83 Specific Arrays
 *                               CS8409/CS42L83
 ******************************************************************************/

const struct hda_verb cs8409_cs42l83_init_verbs[] = {
	{ CS8409_PIN_AFG, AC_VERB_SET_GPIO_WAKE_MASK, 0x0001 },		/* WAKE from GPIO0 */
	{ CS8409_PIN_VENDOR_WIDGET, AC_VERB_SET_PROC_STATE, 0x0001 },	/* Enable VPW processing */
	{ CS8409_PIN_VENDOR_WIDGET, AC_VERB_SET_COEF_INDEX, 0x0002 },	/* Configure GPIO 6,7 */
	{ CS8409_PIN_VENDOR_WIDGET, AC_VERB_SET_PROC_COEF,  0x0080 },	/* I2C mode */
	{ CS8409_PIN_VENDOR_WIDGET, AC_VERB_SET_COEF_INDEX, 0x005b },	/* Set I2C bus speed */
	{ CS8409_PIN_VENDOR_WIDGET, AC_VERB_SET_PROC_COEF,  0x0010 },	/* 50kHz I2C_STO */
	{} /* terminator */
};

/* CS42L83 multi-page I2C bring-up. Addresses are the full 16-bit (page<<8 | reg)
 * values used by the CS8409 paged-I2C engine. Assembled from the macOS
 * AppleHDATDM_CS42L83 init/enable sequence (reverse-engineered by egorenar);
 * the companion DAC is configured for 44.1kHz playback. cs42l42_resume() applies
 * this, then unmutes HP_CTL (0x2001) and enables jack detect via the shared
 * page-0x13/0x1B registers.
 */
static const struct cs8409_i2c_param cs42l83_init_reg_seq[] = {
	/* --- _initHW: jack-detect base config, codec power-up, mic detect --- */
	{ 0x1103, 0x22 },
	{ 0x1129, 0x01 },
	{ 0x1320, 0x0f },
	{ 0x131b, 0x03 },
	...
	{ 0x1501, 0x01 },
	{ 0x1107, 0x01 },
	/* --- _configureSerialPort (44.1kHz) --- */
	{ 0x2505, 0x05 },
	{ 0x2502, 0x05 },
	{ 0x2503, 0x8a },
	{ 0x2506, 0xca },
	{ 0x1208, 0x02 },
	/* --- _setSampleRate (44.1kHz) --- */
	{ 0x2601, 0x4a },
	{ 0x2503, 0x8a },
	{ 0x120a, 0x00 },
	{ 0x1209, 0x01 },
	...
	{ 0x2a05, 0x02 },
	{ 0x100b, 0x00 },
	/* --- buffers on: ASP receive enable channels 1+2 --- */
	{ 0x2a01, 0x0c },
	/* --- enableHeadphones --- */
	{ 0x107e, 0x99 },
	{ 0x1b08, 0x30 },
	{ 0x2102, 0x00 },
	{ 0x107e, 0x00 },
	{ 0x2001, 0x01 },	/* HP_CTL: clear ANA_MUTE_AB (bits 3:2) */
	/* --- tip sense: iMac uses an inverted jack-presence circuit --- */
	{ 0x1b73, 0xe0 },
	/* --- plug-in interrupt enable: unmask TIP_SENSE_PLUG --- */
	{ 0x1b79, 0xa0 },
};

static const struct hda_pintbl cs8409_cs42l83_pincfgs[] = {
	/* Internal speakers (ASP1) need the external amp driver, so disable them;
	 * this leaves the CS42L83 headphone path (ASP2) as the active analog
	 * output. The headphone/mic pins keep their (correct) BIOS configs.
	 */
	{ CS8409_PIN_ASP1_TRANSMITTER_A, 0x400000f0 },	/* speaker L - disabled */
	{ CS8409_PIN_ASP1_TRANSMITTER_B, 0x400000f0 },	/* speaker R - disabled */
	{ CS8409_PIN_ASP2_TRANSMITTER_A, 0x002b4020 },	/* Headphone out (jack) */
	{ CS8409_PIN_ASP2_RECEIVER_A, 0x00ab9030 },	/* Headset mic (jack) */
	{} /* terminator */
};
...
struct sub_codec cs8409_cs42l83_codec = {
	...
	.suspend = cs42l83_suspend,
	.hp_pin_nid = CS8409_CS42L83_HP_PIN_NID,
	.amic_pin_nid = CS8409_CS42L83_AMIC_PIN_NID,
	.hp_jack_in = 0,
	.mic_jack_in = 0,
	.paged = 1,
	.suspended = 1,
...
const struct hda_quirk cs8409_fixup_tbl[] = {
	...
	SND_PCI_QUIRK(0x106b, 0x1000, "iMac18,3", CS8409_IMAC18_3),
	{} /* terminator */
};
...
const struct hda_model_fixup cs8409_models[] = {
	...
	{ .id = CS8409_IMAC18_3, .name = "imac18-3" },
	{}
};
...
const struct hda_fixup cs8409_fixups[] = {
	...
	[CS8409_IMAC18_3] = {
		.type = HDA_FIXUP_PINS,
		.v.pins = cs8409_cs42l83_pincfgs,
		.chained = true,
		.chain_id = CS8409_IMAC18_3_FIXUPS,
	},
	[CS8409_IMAC18_3_FIXUPS] = {
		.type = HDA_FIXUP_FUNC,
		.v.func = cs8409_cs42l83_fixups,
	},
};
